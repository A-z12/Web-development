            ...
            <div className="col-lg-3">
                ...
                <div className="filters">
                    <ul>
                        ...
                        <li data-filter=".tsh">Data Analytics</li>
                    </ul>
                </div>
            </div>
                    ...
                    <div className="row grid">
                        ...
                        <div className="col-lg-4 col-md-4 col-sm-6 col-xs-12 all des">
                          <div className="item">
                            ...
                            <a href="assets/images/tb_Main Page.png" data-lightbox="image-1" data-title="Our Projects"><img src="assets/images/tb_Main Page.png" alt=""/></a>
                          </div>
                        </div>
                    </div>
                </div>
